			...
			subStages: new SequencedLoreSubStage[] {
				new SequencedLoreSubStage(
					...
					objective: new FlatObjective(
						title: SequencedLoreEventManager.ObjectiveTitle_InvestigateDungeon,
				...
				new SequencedLoreSubStage(
					...
					objective: new PercentObjective(
						title: SequencedLoreEventManager.ObjectiveTitle_Find10Mirrors,
						description: "Create or locate 10 Mounted Magic Mirrors on your map.",
						condition: ( obj ) => (float)SequencedLoreEventManager.CountDiscoveredMirrors() / 10f
					)
				)
			},
			isRepeatable: false
