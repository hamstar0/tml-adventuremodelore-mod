...
namespace AdventureModeLore.Lore.Sequenced {
	public partial class SequencedLoreEventManager : ILoadable {
			...
			subStages: new SequencedLoreEventSubStage[] {
				new SequencedLoreEventSubStage(
					...
					objective: new FlatObjective(
						title: SequencedLoreEventManager.ObjectiveTitle_BackgroundPKE,
						...
						condition: ( obj ) => !SequencedLoreEventManager.IsBackgroundPKEDangerous()
					)
				)
			},
			isRepeatable: true
		...
		public static bool IsBackgroundPKEDangerous() {
			...
			return SequencedLoreEventManager._IsBackgroundPKEDangerous();
		}
