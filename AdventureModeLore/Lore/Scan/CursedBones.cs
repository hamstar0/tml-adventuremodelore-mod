...
namespace AdventureModeLore.Lore {
	partial class Scannables : ILoadable {
		private static void LoadScannable_CursedBones_If() {
			if( ModLoader.GetMod( "CursedBones" ) == null ) {
				return;
			}

			Scannables.LoadScannable_CursedBones_WeakRef_If();
		}

		private static void LoadScannable_CursedBones_WeakRef_If() {
