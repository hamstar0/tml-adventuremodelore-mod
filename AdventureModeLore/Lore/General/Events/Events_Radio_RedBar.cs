	...
	public partial class GeneralLoreEventDefinitions {
		...
		private static GeneralLoreEvent GetEvent_Radio_RedBar() {
			...
			string msg = Message.RenderFormattedDescription( NPCID.Guide,
				...
				+" particular thing..."
				+"\n \n"
				+"The only way I know of to dispel this curse is to find the nexus point of these gathering spiritual"
				...
				+" Be sure to prepare, beforehand. Buying some Scaffolding Kits may help."
			);
			/*string msg = Message.RenderFormattedDescription( NPCID.Guide,
				"I have some bad news! Your orbs seem to be non-function, currently."
				+"\n \n"
