	...
	public partial class GeneralLoreEventDefinitions {
		private static GeneralLoreEvent GetEvent_Radio_MagicSecrets() {
			...
			string msg = Message.RenderFormattedDescription( NPCID.Guide,
				...
				+" magic secrets! Don't believe me? Try using magic wherever you can underground, and see what turns"
				+" up!"
				+"\n \nJust don't forget: That's what the ancient peoples were also doing. We all know how that"
				+" turned out..."
			);
