	...
	public partial class GeneralLoreEventDefinitions {
		private static GeneralLoreEvent GetEvent_Radio_MagicSecrets() {
			...
			string msg = Message.RenderFormattedDescription( NPCID.OldMan,
				...
				+"\n \n"
				+"Anyway, if you're intent on exploring the depths, I can suggest one thing: Magic powers can reveal magic"
				+" secrets! Don't believe me? Try using magic wherever you can underground, and see what turns up!"
				+"\n \n"
